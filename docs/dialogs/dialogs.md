...
2026-06-15 11:10 请打包后端
2026-06-15 12:02 在建项目上传的步骤交付物和里程碑交付物，删除时请把浏览生成的PDF缓存文件也一起删掉。合同外需求、项目风险、项目周报、项目评论标签中上传的文件，删除时如果有PDF缓存也一起删掉。
2026-06-15 12:10 可以，继续吧